...
[[nodiscard]] std::vector<RankedHit>
rank_bm25(const Index &index, const std::vector<std::string> &terms, std::size_t topk,
          const std::vector<DocId> &candidates = {}, Bm25Params params = {});
